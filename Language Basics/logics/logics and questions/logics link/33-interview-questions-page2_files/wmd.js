...
Attacklab.wmdBase = function(){
	...
	wmd.editor = function(previewRefreshCallback){
		...
		var makeSpritedButtonRow = function(){
			...
			if((wmd.wmd_env.buttons.search("bold"))>=0){
			...
			if((wmd.wmd_env.buttons.search("italic"))>=0){
			...
			if((wmd.wmd_env.buttons.search("bold"))>=0 || (wmd.wmd_env.buttons.search("italic"))>=0){
			...
			if((wmd.wmd_env.buttons.search("blockquote"))>=0){
			...
			if((wmd.wmd_env.buttons.search("code"))>=0){
			...
			if((wmd.wmd_env.buttons.search("image"))>=0){
			...
			if((wmd.wmd_env.buttons.search("link"))>=0 || (wmd.wmd_env.buttons.search("blockquote"))>=0 || (wmd.wmd_env.buttons.search("code"))>=0 || (wmd.wmd_env.buttons.search("image"))>=0){
			var spacer2 = document.createElement("li");
			spacer2.className = "wmd-spacer";
			spacer2.id = "wmd-spacer2";
			buttonRow.appendChild(spacer2); 
			}
			if((wmd.wmd_env.buttons.search(" ol"))>=0){
			...
			if((wmd.wmd_env.buttons.search("ul"))>=0){
			...
			if((wmd.wmd_env.buttons.search("heading"))>=0){
			...
			if((wmd.wmd_env.buttons.search("hr"))>=0){
			...
			if((wmd.wmd_env.buttons.search("ol"))>=0 || (wmd.wmd_env.buttons.search("ul"))>=0 || (wmd.wmd_env.buttons.search("heading"))>=0 || (wmd.wmd_env.buttons.search("hr"))>=0){
...
if(!Attacklab.wmd)
{
	Attacklab.wmd = function()
	{
		Attacklab.loadEnv = function()
		{
			...
			//bold italic link blockquote code image ol ul heading hr
